...
class ForecastingService @Inject()(rateService: RateService) {
  ...
  def calculateRevaluedStartingAmount(amountA2016: BigDecimal, amountB2016: BigDecimal): BigDecimal = {
    ...
    if (startingAmount2016 < rateService.MAX_AMOUNT_2016) (startingAmount2016 * rateService.taxRates.startingAmount).setScale(2, RoundingMode.HALF_UP)
      ...
      (protectedPayment2016 * rateService.taxRates.protectedPayment).setScale(2, RoundingMode.HALF_UP) + rateService.MAX_AMOUNT
    }
  }
